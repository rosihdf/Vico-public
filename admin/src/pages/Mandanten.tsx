...
import { fetchLicenses, type LicenseWithTenant } from '../lib/licensePortalService'
...
const Mandanten = () => {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Laden fehlgeschlagen. Supabase-Verbindung prüfen.')
    } finally {
      setIsLoading(false)
    }
  }, [])
