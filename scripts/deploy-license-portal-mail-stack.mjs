#!/usr/bin/env node
/**
 * Deployt den zentralen Mandanten-Mail-Stack im Lizenzportal (vier Functions):
 * send-tenant-email, send-tenant-email-server, admin-send-test-email, admin-preview-mail-template
 *
 * Die Function **license** ist separat: npm run lp:deploy:mandanten-update
 *
 *   npm run lp:deploy:mail-stack
 *   npm run lp:deploy:mail-stack -- --project-ref <ref>
 */
