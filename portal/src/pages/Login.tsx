    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-100 to-slate-200 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-800">Vico Kundenportal</h1>
          <p className="text-sm text-slate-500 mt-1">Zugriff auf Ihre Wartungsberichte</p>
        </div>
          ...
          <div className="flex border-b border-slate-200">
            <button
              ...
              className={`flex-1 py-3 text-sm font-medium transition-colors ${
                mode === 'magic'
                  ? 'text-vico-primary border-b-2 border-vico-primary bg-vico-primary/5'
          ...
          >
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-vico-primary focus:border-transparent"
                required
                autoComplete="email"
