...
| **WP-MANG-01** | **Aggregation:** offene Protokoll-Mängel pro `object_id` aus maßgeblichem Completion-Stand (letzter **erledigter** Wartungsauftrag + Regeln §11.17#4); Performance/Cache | ✅ | `protocolOpenMangels.ts`, `fetchProtocolOpenMangelsForListCounters`; optional Performance bei sehr großen Mandanten |
