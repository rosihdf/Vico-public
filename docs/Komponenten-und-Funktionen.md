...
### 5.1 refresh-holidays
- **Funktion:** Feiertage von feiertage-api.de laden, in `public_holidays` speichern

### 5.2 send-maintenance-report
- **Funktion:** Wartungsprotokoll-PDF per E-Mail versenden (Resend)

### 5.3 request-portal-magic-link
- **Funktion:** Magic-Link für Kundenportal generieren und versenden

### 5.4 invite-portal-user
- **Funktion:** Portal-Benutzer einladen

### 5.5 notify-portal-on-report
- **Funktion:** Kundenportal bei neuem Wartungsprotokoll benachrichtigen

### 5.6 cleanup-demo-data
- **Funktion:** Demo-Mandanten-Daten nach 24h löschen

### 5.7 send-standort-push
- **Funktion:** Web-Push-Benachrichtigung bei Standortanfrage an Mitarbeiter
...
### 6.1 license
- **Funktion:** Lizenzstatus abfragen, Features, Grenzen, Impressum

### 6.2 limit-exceeded
- **Funktion:** Grenzüberschreitungen von Haupt-App/Kunden empfangen und speichern

### 6.3 update-impressum
- **Funktion:** Impressum-Stammdaten pro Mandant aktualisieren

---

## 7. Services und Kontexte (Haupt-App)

| Service/Kontext | Funktion |
|-----------------|----------|
...
*Letzte Aktualisierung: siehe Build-Datum. Bei neuen Features diese Datei ergänzen.*
